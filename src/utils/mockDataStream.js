...
export const INITIAL_NODES = [
  {
    ...
    thermalFeed: getAssetUrl('images/thermal_crack.jpg'),
    fogFeed: getAssetUrl('images/fog_camera.jpg'),
    tiltX: 0.8,
    tiltY: 0.5,
  ...
  },
  {
    ...
    image: getAssetUrl('images/node3_pillar.jpg'),
    thermalFeed: getAssetUrl('images/thermal_crack.jpg'),
    fogFeed: getAssetUrl('images/fog_camera.jpg'),
    tiltX: 1.1,
    tiltY: 0.7,
  ...
  },
  {
    ...
    image: getAssetUrl('images/node4_vent.jpg'),
    thermalFeed: getAssetUrl('images/thermal_crack.jpg'),
    fogFeed: getAssetUrl('images/fog_camera.jpg'),
    tiltX: 0.6,
    tiltY: 0.4,
  ...
  },
  {
    ...
    image: getAssetUrl('images/sensor_node.jpg'),
    thermalFeed: getAssetUrl('images/thermal_crack.jpg'),
    fogFeed: getAssetUrl('images/fog_camera.jpg'),
    tiltX: 0.9,
    tiltY: 0.6,
  ...
  },
  {
    ...
    image: getAssetUrl('images/node6_surface.jpg'),
    thermalFeed: getAssetUrl('images/thermal_crack.jpg'),
    fogFeed: getAssetUrl('images/fog_camera.jpg'),
    tiltX: 0.1,
    tiltY: 0.1,
